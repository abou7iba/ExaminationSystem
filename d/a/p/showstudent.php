...
<?php
    if(isset($_GET['delete'])){
        ...
        mysqli_query($con, "DELETE FROM student WHERE st_id  ='$delete_id'");
     }
    if(true){
...
if(isset($_POST['search'])){
    ...
    $sql_sel_student = "SELECT * FROM student WHERE department ='$department_search' AND band ='$band_search' ";
    ...
    while($row = mysqli_fetch_assoc($res)){
        ...
        echo '<td><a href="editstudent.php?edit='.$st_id.'">تعديل</a></td>';
        echo '<td><a style="color:red;" href="showstudent.php?delete='.$st_id.'">حذف</a></td>';
        echo '</tr>';
