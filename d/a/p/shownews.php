...
<?php
    if(isset($_GET['delete'])){
        ...
        mysqli_query($con, "DELETE FROM student_news WHERE news_id ='$delete_id'");
    }
    if(true){
...
<table>
<thead >
    <th colspan="3" class="head-table"> الاخبار </th><br>
</thead>
<thead>
  <tr>
    <th>الخبر</th>
...
$res = mysqli_query($con, $sql_sel_student_news);
//  loop to get all data 
while($row = mysqli_fetch_assoc($res)){
...
echo '<tr>';
echo '<td>'. $news_text .'</td>';
echo '<td><a href="editnews.php?edit='.$news_id.'">تعديل</a></td>';
echo '<td  ><a style="color:red;" href="shownews.php?delete='.$news_id.'">حذف</a></td>';
echo '</tr>';
}
} 
?>
