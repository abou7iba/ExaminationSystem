...
if(true){
// Get Data from Sql database
$sql_sel_teacher = "SELECT * FROM table_ex WHERE table_ex ='$table_id_edit'";
$res = mysqli_query($con, $sql_sel_teacher);
...
?>
        <label for="">تعديل جدول امتحان : </label><br>
        
        
        <input type="text" name="name_ex" placeholder="اسم المادة" value="<?php echo $ex_name?>" >
        <input type="date" name="date_ex"  value="<?php echo $ex_date?>" >
        <input type="time" name="time_ex"  value="<?php echo $ex_time?>">
...
?>
        ...
        <input type="submit" value="تعديل" name="edittablebtn">
        </center>
        <br>
    </div>

<?php
if(isset($_POST['edittablebtn'])){
    ...
    $update = "UPDATE table_ex SET `ex_name`='$name_ex',`ex_date`='$date_ex',`ex_time`='$time_ex',`ex_band`='$band',`ex_department`='$department' WHERE table_ex = '$table_id_edit'";
    mysqli_query($con, $update);
    
    header('LOCATION: edittable.php?edit='.$table_id_edit.'');
}
?>
</form>
