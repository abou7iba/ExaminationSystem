                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="dashexam.php">
                            ...
                            <span class="text nav-text">الامتحانات</span>
                        </a>
                    </li>
    ...
    <section class="home">
        ...
        <table>
            ...
            <thead>
              ...
              <tr>
                  <td>الامتحانات</td>
                  <td><a href="p/addexam.php">اضافة</a></td>
                  <td><a href="p/showexam.php">عرض</a></td>
              </tr>

              <tr>
                  <td>الاشعارات</td>
                  <td><a href="p/addnoti.php">اضافة</a></td>
                  <td><a href="p/notifications.php">عرض</a></td>
              </tr>
