...
<?php
    if(isset($_GET['delete'])){
        ...
        mysqli_query($con, "DELETE FROM notifications WHERE noti_id  ='$delete_id'");
     }
if(true){
...
<thead >
    <th colspan="4" class="head-table"> الاشعارات </th><br>
</thead>
<thead>
  <tr>
    <th>الاشعار</th>
...
echo '<td><a href="p/editnoti.php?edit='.$noti_id.'">تعديل</a></td>';
echo '<td><a style="color:red;" href="noti.php?delete='.$noti_id.'">حذف</a></td>';
echo '</tr>';
}
} 
?>
